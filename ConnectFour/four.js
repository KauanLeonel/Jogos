document.addEventListener('DOMContentLoaded', () =>{ //Faz com que o DOM carregue primeiro e não haja confusão no código
    ...
    const displayCurrentPlayer = document.querySelector('#current-player') //Pega o jogador atual
    let currentPlayer = 1; //Faz com que sempre o player1 comece
    const winningArrays = [ //Todas as posições vencedoras
